...
export default {
  ...
  methods: {
    async init() {
      ...
      await this.$axios.get('/api/visual/arrivalTime?date=' + _this.realTimeDate).then(response => {
        ...
        //set indicator
        let indicator = [
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '23:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '22:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '21:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '20:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '19:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '18:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '17:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '16:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '15:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '14:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '13:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '12:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '11:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '10:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '09:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '08:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '07:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '06:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '05:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '04:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '03:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '02:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '01:00', max: this.maxCount },
          { name: '', max: this.maxCount }, { name: '', max: this.maxCount }, {
            name: '',
            max: this.maxCount,
          }, { name: '00:00', max: this.maxCount }]
    ...
    async updateArrivalTimeChartData(curTime) {
       ...
       */
      await this.$axios.get('/api/visual/arrivalTime?date=' + curTime).then(response => {
